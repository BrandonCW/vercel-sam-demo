...
/**
 * The messages that drive the two Assessment Session turns. The
 * /api/qualification routes and the live evals send exactly these, so the
 * evals exercise the same agent contract as the UI.
 */
